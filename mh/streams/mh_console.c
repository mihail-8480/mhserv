...
mh_console_t mh_console_open(mh_context_t* context) {
    ...
    mh_console._out = mh_file_stream_new(context, stdout, false);
    mh_console._in = mh_file_stream_new(context, stdin, false);
    mh_console._err = mh_file_stream_new(context, stderr, false);
